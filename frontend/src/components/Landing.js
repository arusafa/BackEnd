  ...
  return (
    <div>
      ...
      <div className="link_wrapper">
        ...
        <Link className="a" to={"/home/register/tutor"}>Sign Up</Link>
        <Link className="a" to={"/home/login/tutor"}>Log In</Link>
        <Link className="a" to={"home/register/tutor/result"}>DataDisplay</Link>
      </div>
    </div>
  );
}